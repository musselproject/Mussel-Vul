...
@torch.no_grad()
def init_wandb(entity, project, wandb_id, runname):
...
def run_exp(args: Optional[Dict[str, Any]] = None, callbacks: List["TrainerCallback"] = []) -> None:
    ...
    #     print('[CookieInfo] log into wandb.')
    #     init_wandb('LLaMA-Factory', finetuning_args.wandb_project_name, '1', finetuning_args.wandb_name)
