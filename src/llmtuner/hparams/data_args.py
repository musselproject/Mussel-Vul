...
class DataArguments:
    ...
    dpo_answer_cutoff_len: int = field(
        default=512,
        metadata={"help": "The cutoff length of the tokenized inputs in the dataset."},
    )
    ...
    num_return_sequences: Optional[int] = field(
        default=1.0,
        metadata={"help": "Data nums returned by beam-based generation."},
    )
    extend_data_num: Optional[int] = field(
        default=None,
        metadata={"help": "Exponential penalty to the length that is used with beam-based generation."},
    )
    start_num_index: Optional[int] = field(
        default=None,
        metadata={"help": "Start_num_index."},
    )
