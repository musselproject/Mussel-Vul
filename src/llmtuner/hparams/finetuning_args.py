...
class RLHFArguments:
    ...
    multi_dpo: Optional[bool] = field(
        default=False,
        metadata={"help": "Whether to use multi dpo training."},
    )
    multi_dpo_reject_data_num: Optional[int] = field(
        default=2,
        metadata={"help": "Multi dpo training data num."},
    )
    debug_dpo: Optional[bool] = field(
        default=False,
        metadata={"help": "Whether to debug dpo."},
    )
    debug_dpo_loss: Optional[bool] = field(
        default=False,
        metadata={"help": "Whether to debug dpo loss."},
    )
    enable_msrdpo_weight: Optional[bool] = field(
        default=True,
        metadata={"help": "Whether to enable MSRDPO weight."},
    )
    enable_reciprocal: Optional[bool] = field(
        default=True,
        metadata={"help": "Whether to enable MSRDPO weight reciprocal."},
    )
    weight_factor: float = field(
        default=1,
        metadata={"help": "The msr-dpo weight_factor."},
    )
    len_penalty_factor: float = field(
        default=0.0001,
        metadata={"help": "The msr-dpo len_penalty_factor."},
    )
    wandb_name: str = field(
        default="wandb_default",
        metadata={
            "help": "Default wandb pro sub-name."
        },
    )
    wandb_project_name: str = field(
        default="wandb_default",
        metadata={
            "help": "Default wandb pro name."
        },
    )
